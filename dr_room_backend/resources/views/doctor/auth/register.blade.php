...
<head>
    ...
    <title>DrRoom - Doctor Register</title>
            ...
            <div class="left-content">
                ...
                <form method="POST" action="{{ route('doctor.register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="specialty" value="{{ old('specialty') }}" required dir="auto" class="form-control" placeholder="Specialty (e.g. Dentist)">
                    </div>
