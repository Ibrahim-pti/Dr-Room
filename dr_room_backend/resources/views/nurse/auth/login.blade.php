...
<head>
    ...
    <title>DrRoom - Nurse Login</title>
    ...
    <style>
        ...
        */
        ...
        .remember input { width: 18px; height: 18px; accent-color: #A855F7; cursor: pointer; }
        .forgot { font-size: 13px; color: #A855F7; font-weight: 600; text-decoration: none; }
        ...
        .signup a { color: #A855F7; font-weight: 600; text-decoration: none; }
    ...
    <div class="split-layout">
        ...
        <div class="left-side">
            <div class="left-content">
                ...
                <div class="signup">
                    Don't have an account? <a href="{{ route('nurse.register') }}">Sign up</a>
                </div>
            </div>
