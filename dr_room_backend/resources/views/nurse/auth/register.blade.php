...
<head>
    ...
    <title>DrRoom - Nurse Register</title>
    ...
    <style>
        ...
        */
        ...
        .signup a { color: #8B5CF6; font-weight: 600; text-decoration: none; }
    ...
    <div class="split-layout">
        ...
        <div class="left-side">
            <div class="left-content">
                ...
                <form method="POST" action="{{ route('nurse.register') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="specialty" value="{{ old('specialty') }}" required dir="auto" class="form-control" placeholder="Specialty (e.g. Registered Nurse)">
                    </div>
                ...
                <div class="signup">
                    Already have an account? <a href="{{ route('nurse.login') }}">Login</a>
                </div>
            </div>
        ...
        <div class="right-side">
            <img src="{{ asset('images/nurse.png') }}" alt="Nurse">
        </div>
    </div>
