...
class _BodyMapScreenState extends State<BodyMapScreen> {
  ...
  final List<Map<String, dynamic>> systems = [
    ...
    {'name': 'Muscular', 'icon': Icons.fitness_center, 'color': const Color(0xFF6366F1)},
    ...
    {'name': 'Reproductive', 'icon': Icons.transgender, 'color': const Color(0xFF8B5CF6)},
  ...
  final Map<String, Map<String, dynamic>> organQuickData = {
    'head': {
      ...
      'stats': [
        {'value': '1.4 kg', 'label': 'Avg Weight', 'icon': Icons.scale_outlined},
    ...
    'chest': {
      ...
      'stats': [
        {'value': '70-100', 'label': 'Beats / Min', 'icon': Icons.favorite_border},
        {'value': '250-350', 'label': 'grams Weight', 'icon': Icons.scale_outlined},
        {'value': 'Left Side', 'label': 'of Chest', 'icon': Icons.location_on_outlined},
        {'value': 'Life Long', 'label': 'Duration', 'icon': Icons.access_time_rounded},
      ],
      'functions': [
      ...
      'fact': 'Your heart beats about 100,000 times a day and pumps over 7,500 liters of blood through your body!',
    },
    'abdomen': {
      ...
      'stats': [
        {'value': '1.5 Liters', 'label': 'Capacity', 'icon': Icons.water_drop_outlined},
        {'value': 'pH 1.5 - 3.5', 'label': 'Acidity', 'icon': Icons.science_outlined},
        {'value': 'Abdominal', 'label': 'Cavity', 'icon': Icons.location_on_outlined},
        {'value': '24-72 hrs', 'label': 'Transit', 'icon': Icons.timer_outlined},
      ],
      'functions': [
      ...
      'fact': 'The lining of your stomach replaces itself every few days to prevent digestive acids from dissolving it!',
    },
    'arms': {
      ...
      'stats': [
        {'value': '30+ Muscles', 'label': 'Upper Arm', 'icon': Icons.fitness_center},
        {'value': 'Humerus', 'label': 'Main Bone', 'icon': Icons.accessibility},
        {'value': 'Full 360°', 'label': 'Rotator Cuff', 'icon': Icons.rotate_right},
        {'value': 'Motor Power', 'label': 'Articulation', 'icon': Icons.pan_tool},
      ],
      'functions': [
      ...
      'fact': 'The muscles in your forearm control the complex movements of your fingers through a network of tendons!',
    },
    'legs': {
      ...
      'stats': [
        ...
        {'value': 'Patella', 'label': 'Knee Cap', 'icon': Icons.shield_outlined},
        {'value': '3x Body Wt', 'label': 'Load Capacity', 'icon': Icons.speed},
        {'value': 'Bipedal', 'label': 'Locomotion', 'icon': Icons.directions_walk},
      ],
      'functions': [
      ...
      'fact': 'The femur bone in your leg is stronger than concrete and can support up to 30 times your body weight!',
    },
  };
  ...
  void _handleViewChange(String viewName) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    final activeOrganData =
        selectedOrgan != null ? organQuickData[selectedOrgan] : null;
            ...
            Expanded(
              child: Stack(
                children: [
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: GestureDetector(
                                    behavior: HitTestBehavior.translucent,
                                    onTap: () =>
                                        setState(() => selectedOrgan = 'abdomen'),
                                    child: Center(
                  ...
                  // Right side Floating Controls (Zoom & Views Switcher)
                  Positioned(
                    right: 14,
                    top: 10,
                    child: Column(
      ...
      child: Column(
        ...
        children: [
          ...views.map((view) {
            ...
            return GestureDetector(
              onTap: () => _handleViewChange(view['name']),
              child: AnimatedContainer(
                duration: const Duration(milliseconds: 200),
  ...
  Widget _buildZoomControls() {
    return Container(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          _buildZoomItem(Iconsax.rotate_left_copy, 'Rotate', _rotate360Step),
  ...
  Widget _buildBottomToolbar() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildCircularNavButton(Iconsax.rotate_left_copy, 'Rotate', true, onTap: _rotate360Step),
          _buildCircularNavButton(Iconsax.search_zoom_in_copy, 'Zoom', false),
          _buildCircularNavButton(Icons.label_outline, 'Labels', false),
          _buildCircularNavButton(Iconsax.refresh_copy, 'Reset', false, onTap: _resetCamera),
  ...
  Widget _buildCircularNavButton(IconData icon, String label, bool isActive, {VoidCallback? onTap}) {
