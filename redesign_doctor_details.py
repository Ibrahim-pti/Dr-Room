...
code = '''import 'package:dr_room/main.dart';
      ...
      body: Stack(
        children: [
          CustomScrollView(
            ...
            slivers: [
              // ── Ultra Modern Flexible Hero Header ──
              SliverAppBar(
                expandedHeight: 340,
                pinned: true,
                stretch: true,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ── Intro Video Player Card (If Available) ──
                      if (_youtubeController != null || (_videoPlayerController != null && _videoPlayerController!.value.isInitialized)) ...[
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20),
                          child: Container(
                            decoration: BoxDecoration(
